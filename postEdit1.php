...
<?php
        ...
        $query = "SELECT * FROM id17483408_ucm.Post where idPost= $id;";
...
<section data-bs-version="5.1" class="features9 cid-sQRoQzOhJd" id="features10-f">
    ...
    <div class="container">
        ...
        <div class="row mt-4">
        <form action="edit2.php?id=<?php echo $id?>" method="POST" class="mbr-form form-with-styler" data-form-title="Form Name">
                    <div class="dragArea row">
                        ...
                        <div class="col-md col-sm-12 form-group mb-3" data-for="asunto">
                            <input type="text" name="Asunto" placeholder="Asunto" data-form-field="asunto" class="form-control" value="<?php echo $mostrar['Asunto'] ?>" id="Asunto">
                        </div>
                        <div class="col-md col-sm-12 form-group mb-3" data-for="name">
                            <input type="text" name="Url" placeholder="Url" data-form-field="url" class="form-control" value="<?php echo $mostrar['Url'] ?>" id="Url">
                        </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 align-center mbr-section-btn"><a href="comicsCat.php" class="btn btn-black display-4">Volver</a></div>
        </div>
    </div>
</section>

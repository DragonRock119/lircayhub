...
<head>
  ...
  <title>Categoría Marvel Comics</title>
    ...
    <div class="container">
        <div class="mbr-section-head">
            <h3 class="mbr-section-title mbr-fonts-style mb-0 display-2">
                <strong>Marvel Comics</strong></h3>
            
        </div>
        <div class="row mt-4">
        <?php
                    
                    $query = 'SELECT * FROM id17483408_ucm.Post where Categoria = 2;';
            ...
            <a href="<?php echo $mostrar['DatoNom']?>"><div class="card col-12">
                <div class="card-wrapper">
                    ...
                    <div class="row">
                        <div class="col-2">
                            <a href="postEdit1.php?id=<?php echo $mostrar['idPost']?>" class="btn btn-black display-4">Editar</button></a>
                        </div>
                        <div class="col-2">
                            <a href="postDel1.php?id=<?php echo $mostrar['idPost']?>" class="btn btn-black display-4">Eliminar</button></a>
                        </div>
                    </div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center mt-4">
            <div class="col-lg-8 mx-auto mbr-form" data-form-type="formoid">
                <form action="comicIng.php" method="POST" class="mbr-form form-with-styler" data-form-title="Form Name">
                    <div class="dragArea row">
                        ...
                        <div class="col-md col-sm-12 form-group mb-3" data-for="name">
                            <input type="text" name="Url" placeholder="Url" data-form-field="url" class="form-control" value="" id="Url">
                        </div>

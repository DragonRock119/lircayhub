    ...
    <div class="container">
        <div class="mbr-section-head">
            <h3 class="mbr-section-title mbr-fonts-style mb-0 display-2">
                <strong>UCM</strong></h3>
            
        </div>
        <div class="row mt-4">
        <?php
                    
                    $query = 'SELECT * FROM id17483408_ucm.Post where Categoria = 1;';
            ...
            <a href="<?php echo $mostrar['DatoNom']?>"><div class="card col-12">
                <div class="card-wrapper">
                    ...
                    <div class="row">
                        <div class="col-2">
                            <a href="postEdit.php?id=<?php echo $mostrar['idPost']?>" class="btn btn-black display-4">Editar</button></a>
                        </div>
                        <div class="col-2">
                            <a href="postDel.php?id=<?php echo $mostrar['idPost']?>" class="btn btn-black display-4">Eliminar</button></a>
                        </div>
                    </div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center mt-4">
            <div class="col-lg-8 mx-auto mbr-form" data-form-type="formoid">
                <form action="ucmIng.php" method="POST" class="mbr-form form-with-styler" data-form-title="Form Name">

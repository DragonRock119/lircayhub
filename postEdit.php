...
<section data-bs-version="5.1" class="features9 cid-sQRoQzOhJd" id="features10-f">
    ...
    <div class="container">
        ...
        <div class="row mt-4">
        <form action="edit.php?id=<?php echo $id?>" method="POST" class="mbr-form form-with-styler" data-form-title="Form Name">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 align-center mbr-section-btn"><a href="ucmCat.php" class="btn btn-black display-4">Volver</a></div>
        </div>
    </div>
</section>
